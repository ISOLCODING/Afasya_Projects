...
const TiltCard = ({ 
   ...
   return (
      ...
      >
         {glowEffect && (
            <motion.div
               className="absolute -inset-1 bg-linear-to-r from-primary-500/20 via-accent-500/20 to-primary-500/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
               style={{
